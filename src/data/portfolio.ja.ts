  ...
  education: [
    {
      ...
      summary:
        '現在の私のソフトウェアエンジニアリング志向を最もよく表す学位で、バックエンド、プラットフォーム、プロダクト実装に最も直結しています。',
      details: [
        'バックエンド、分散システム、スケーラブルなソフトウェアプラットフォームへの関心を深めました。',
        'ソフトウェアエンジニアリング、プロダクト実装、システム思考を明確につなぐ学位です。',
        '現在のフルスタック開発や応用 AI の土台になっている専攻です。',
      ],
      iconPath: '/andes.jpg',
      iconAlt: 'Universidad de los Andes logo',
    },
    {
      ...
      gpa: 'GPA: 4.37 / 5.0',
      summary:
        '電子工学、工学的な厳密さ、そしてソフトウェアと現実の技術システムの接点に対する理解を広げました。',
      details: [
        '設計制約やハードウェアを含む問題解決への理解を強めました。',
        'ソフトウェアと実装・デバイスのつながりを考える視点に厚みを加えました。',
        '学際的な工学分野での分析的思考をさらに強化しました。',
      ],
      iconPath: '/andes.jpg',
      iconAlt: 'Universidad de los Andes logo',
    },
    {
      ...
      gpa: 'GPA: 4.33 / 5.0',
      summary:
        'ソフトウェアが明確な中心になる前の段階で、定量性とシステム思考の強い土台を築いた学位です。',
      details: [
        '構造的な技術課題解決のための基礎を広げました。',
        '抽象的な分析、厳密さ、技術的な深さへの強い基盤を与えました。',
        '現在のソフトウェアやプラットフォーム志向を補完する学位です。',
      ],
      iconPath: '/andes.jpg',
      iconAlt: 'Universidad de los Andes logo',
    },
    {
      ...
      duration: '6 months',
      summary:
        '初めての国際的な学習経験で、英語力を大きく伸ばし、多文化環境での適応力と自信を得ました。',
      details: [
        '英語での学術コミュニケーション、流暢さ、実践的な会話力に重点を置いた集中プログラムでした。',
        'アメリカの複数の都市を訪れ、早い段階で国際的な視野を広げる機会になりました。',
        'その後の国際協働や学習経験を支えるコミュニケーション力とグローバルな視点の土台になりました。',
      ],
      iconPath: '/ef.jpeg',
    ...
    },
    {
      ...
      gpa: 'GPA: 4.4 / 5.0',
      summary:
        '大学進学前に、学習規律、コミュニケーション力、継続性の基礎を作ったバイリンガル教育の土台です。',
      details: [
        '工学進学前の最も早い正式な教育段階でした。',
        'バイリンガル環境を通じて、コミュニケーション力、規律、継続性を強めました。',
        '大学生活や国際経験につながる学習習慣の出発点になりました。',
      ],
